...
use Modules\QualityControl\DataTables\ScheduleInspectionDataTable;
...
class ScheduleInspectionController extends AccountBaseController
{
    ...
    {
        abort_403(user()->permission('delete_quality_control') != 'all');
    ...
    {
        abort_403(user()->permission('edit_quality_control') != 'all');
    ...
    public function destroy($id)
    {
        ...
        $this->deleteInspectionPermission = user()->permission('delete_quality_control');
    ...
    public function updateOtherData(Request $request, $id)
    {
        ...
        if ($items_total == $jumlah) {
            ...
            // Cleaner workflow: flag as Needs Re-Clean when not all items are checked.
    ...
    {
        $viewInspectionPermission = user()->permission('view_quality_control');
