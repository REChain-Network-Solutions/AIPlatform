...
<div class="mb-3">
  <label class="form-label">{{ __('inspection::templates.fields.name') }}</label>
  <input type="text" name="name" class="form-control" value="{{ old('name', $template->name ?? '') }}" required>
</div>

<div class="mb-3">
  <label class="form-label">{{ __('inspection::templates.fields.trade') }}</label>
  <input type="text" name="trade" class="form-control" value="{{ old('trade', $template->trade ?? '') }}">
</div>

<div class="mb-3">
  <label class="form-label">{{ __('inspection::templates.fields.description') }}</label>
...
<div class="form-check mb-3">
  ...
  <label class="form-check-label" for="is_active">{{ __('inspection::templates.fields.active') }}</label>
</div>
