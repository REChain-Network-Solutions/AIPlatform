        ...
        <div class="row px-lg-4 px-md-4 px-3 py-3">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="remark" id="description-text" rows="5" class="form-control"></textarea>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group mb-lg-0 mb-md-0 mb-4">
            ...
            <div class="col-lg-12">
                <x-forms.file allowedFileExtensions="png jpg jpeg svg" class="mr-0 mr-lg-2 mr-md-2 cropper"
                    :fieldLabel="__('engineerings::app.menu.foto')" fieldName="image" fieldId="image" fieldHeight="119" />
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" min="100"
                                        ...
                                        name="items_harga[]" id="harga" readonly>
                                </td>
                                <td>
                                    <div class="select-others height-35 rounded border-0">
                                        <select name="items_tax[]" class="form-control select-picker">
                                            ...
                                            @foreach ($taxes as $tax)
                                                <option data-rate="{{ $tax->rate_percent }}"
                                                    value="{{ $tax->rate_percent }}">{{ $tax->rate_percent }}%
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <tr>
                                <td width="35%">
                                    <div class="select-others height-35 rounded border-0">
                                        <x-forms.input-group>
                                            <select class="form-control select-picker height-35 f-14 services_id"
                                            ...
                                            <x-slot name="append">
                                                <a href="{{ route('services.index') }}"
                                                    class="btn btn-outline-secondary border-grey openRightModal float-left">
                                                    @lang('app.add')
                                                </a>
                                            </x-slot>
                                        </x-forms.input-group>
                                ...
                                <td width="16%">
                                    <input type="number" min="100"
                                        class="form-control f-14 height-35 rounded w-100 text-right"
                                        name="services_harga[]" id="harga" readonly>
                                </td>
                                <td width="17%">
                                    <div class="select-others height-35 rounded border-0">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuBtn" tabindex="0">
                    <li>
                        <a class="dropdown-item f-14 text-dark save-form" href="javascript:;" data-type="save">
                            <i class="fa fa-save f-w-500 mr-2 f-11"></i> @lang('Save Only')
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item f-14 text-dark save-form" href="javascript:void(0);"
                            data-type="send">
                            <i class="fa fa-paper-plane f-w-500  mr-2 f-12"></i> @lang('Save & Create Work Order')
                        </a>
                    </li>
                </ul>
            </div>
