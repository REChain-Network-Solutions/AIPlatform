...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('feedback', function (Blueprint $table) {
            $table->increments('id');
            $table->bigInteger('feedback_number')->nullable();
            ...
            $table->foreign('channel_id')->references('id')->on('feedback_channels')->onDelete('cascade')->onUpdate('cascade');
            $table->unsignedInteger('type_id')->nullable();
            $table->foreign('type_id')->references('id')->on('feedback_types')->onDelete('cascade')->onUpdate('cascade');
