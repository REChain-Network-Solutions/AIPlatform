<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('app.update') @lang('feedback::modules.feedbackTypes')</h5>
    ...
    <div class="portlet-body">
        <x-form id="editTicketType" method="PUT" class="ajax-form">
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <x-forms.text fieldId="type" :fieldLabel="__('feedback::modules.feedbackTypes')"
...
<script>
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: "{{route('feedbackTypes.update', $type->id)}}",
