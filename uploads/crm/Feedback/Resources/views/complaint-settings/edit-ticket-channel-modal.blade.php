<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('app.update') @lang('feedback::modules.feedbackChannels')</h5>
    ...
    <div class="portlet-body">
        <x-form id="editTicketChannel" method="PUT" class="ajax-form">
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <x-forms.text fieldId="channel_name" :fieldLabel="__('feedback::modules.feedbackChannels')"
...
<script>
    ...
    $('#save-ticket-channel').click(function () {
        $.easyAjax({
            url: "{{route('feedbackChannels.update', $channel->id)}}",
