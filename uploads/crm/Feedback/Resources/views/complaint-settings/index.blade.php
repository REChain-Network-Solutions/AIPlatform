                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 active agent" href="{{ route('feedback-settings.index') }}"
                                role="tab" aria-controls="nav-ticketAgents"
                                aria-selected="true">@lang('feedback::modules.feedbackAgents')
                            </a>

                            <a class="nav-item nav-link f-15 type" href="{{ route('feedback-settings.index') }}?tab=type"
                                role="tab" aria-controls="nav-ticketTypes"
                                aria-selected="true">@lang('feedback::modules.feedbackTypes')
                            </a>

                            <a class="nav-item nav-link f-15 channel"
                                href="{{ route('feedback-settings.index') }}?tab=channel" role="tab"
                                aria-controls="nav-ticketChannel" aria-selected="true">@lang('feedback::modules.feedbackChannels')
                            </a>

                            <a class="nav-item nav-link f-15 reply-template"
                                href="{{ route('feedback-settings.index') }}?tab=reply-template" role="tab"
                                aria-controls="nav-replyTemplates" aria-selected="true">@lang('feedback::modules.feedbackTemplates')
                            </a>

                            {{-- <a class="nav-item nav-link f-15 email-sync"
                                href="{{ route('feedback-settings.index') }}?tab=email-sync" role="tab"
