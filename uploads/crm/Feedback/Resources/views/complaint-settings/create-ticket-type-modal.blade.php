<div class="modal-header">
    <h5 class="modal-title">@lang('app.addNew') @lang('feedback::modules.feedbackTypes')</h5>
    ...
    <div class="portlet-body">
        <x-form id="createTicket" method="POST" class="ajax-form">
            <div class="form-group">
                <div class="row">
                    <div class="col-lg-12 ">
                        <x-forms.text fieldId="type" :fieldLabel="__('feedback::modules.feedbackTypes')" fieldName="type"
