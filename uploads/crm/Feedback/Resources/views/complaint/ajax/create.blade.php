        ...
        <x-form id="save-ticket-data-form">
            ...
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    @lang('feedback::modules.feedback') @lang('app.details')</h4>
                <div class="row p-20">
                    ...
                    <div class="col-md-3">
                        <x-forms.number fieldId="no_hp" :fieldLabel="__('feedback::app.menu.noHP')" fieldName="no_hp" fieldRequired="true"
                            :fieldPlaceholder="__('')">
                            </x-forms.text>
                    </div>

                    <div class="col-md-3">
                        <x-forms.label class="mt-3" fieldId="parent_label" :fieldLabel="__('feedback::app.menu.area')"
                    ...
                    <div class="col-md-3">
                        <x-forms.label class="mt-3" fieldId="parent_label" :fieldLabel="__('feedback::app.menu.houses')"
                            fieldName="parent_label">
                        </x-forms.label>
                ...
                <x-form-actions class="c-inv-btns d-block d-lg-flex d-md-flex">
                    ...
                    <x-forms.button-cancel :link="route('feedback.index')" class="border-0 ">@lang('app.cancel')
...
<script>
    $(document).ready(function() {
        ...
        function houseItems(selectedId) {
            ...
            $.ajax({
                url: '{{ route('feedback.get-items', '') }}' + '/' + selectedId,
                method: 'GET',
        ...
        $('.save-form').click(function() {
            ...
            const url = "{{ route('feedback.store') }}";
            $.easyAjax({
                url: url,
