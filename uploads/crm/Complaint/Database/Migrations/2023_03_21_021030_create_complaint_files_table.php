...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('complaint_files', function (Blueprint $table) {
            ...
            $table->unsignedInteger('complaint_reply_id')->nullable();
            $table->foreign('complaint_reply_id')->references('id')->on('complaint_replies')->onDelete('cascade')->onUpdate('cascade');
