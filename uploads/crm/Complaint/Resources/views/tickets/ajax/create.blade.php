        ...
        <x-form id="save-ticket-data-form">
            ...
            <div class="add-client bg-white rounded">
                ...
                <x-form-actions class="c-inv-btns d-block d-lg-flex d-md-flex">
                    ...
                    @if (in_array('client', user_roles()))
                        <x-forms.button-cancel :link="route('tiket-client.index')" class="border-0 ">@lang('app.cancel')
                        </x-forms.button-cancel>
                    @else
                        <x-forms.button-cancel :link="route('tiket.index')" class="border-0 ">@lang('app.cancel')
                        </x-forms.button-cancel>
                    @endif
                </x-form-actions>
                <!-- CANCEL SAVE END -->
...
<script>
    $(document).ready(function() {
        ...
        taskDropzone.on('completemultiple', function() {
            ...
            window.location.href = "{{ route('tiket.index') }}";
        });
