...
class NewComplaintRequester extends BaseNotification
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        $content = __('email.newTicketRequester.text') . '<br>' . ucfirst($this->complaint->subject) . ' # ' . $this->complaint->complaint_number;

        return parent::build()
            ->subject(__('email.newTicketRequester.subject') . ' - ' . ucfirst($this->complaint->subject) . ' - ' . __('modules.tickets.ticket') . ' # ' . $this->complaint->complaint_number)
            ->markdown('mail.email', [
                'url' => $url,
                'content' => $content,
    ...
    public function toOneSignal($notifiable)
    {
        return OneSignalMessage::create()
            ...
            ->body(ucfirst($this->complaint->subject) . ' # ' . $this->complaint->id);
    }
