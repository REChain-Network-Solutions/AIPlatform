    ...
    public function mergeExtensionMenu($menu)
    {
        ...
        $menu = array_merge($menu, [
            ...
            'crm' => [
                ...
                'show_condition' => Route::has('dashboard.crm.dashboard'),
                'is_admin'       => false,
            ],
            'crm_dashboard' => [
                'parent_key'       => 'crm',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.crm.dashboard'],
                'show_condition'   => Route::has('dashboard.crm.dashboard'),
                'is_admin'         => false,
            ],
            'crm_leads' => [
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.crm.leads.*'],
                'show_condition'   => Route::has('dashboard.crm.leads.index'),
                'is_admin'         => false,
            ],
            'crm_contacts' => [
                'parent_key'       => 'crm',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.crm.contacts.*'],
                'show_condition'   => Route::has('dashboard.crm.contacts.index'),
                'is_admin'         => false,
            ],
            'crm_companies' => [
                'parent_key'       => 'crm',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.crm.companies.*'],
                'show_condition'   => Route::has('dashboard.crm.companies.index'),
                'is_admin'         => false,
            ],
            'crm_deals' => [
                'parent_key'       => 'crm',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.crm.deals.*'],
                'show_condition'   => Route::has('dashboard.crm.deals.index'),
                'is_admin'         => false,
            ],
            'crm_activities' => [
                'parent_key'       => 'crm',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.crm.activities.*'],
                'show_condition'   => Route::has('dashboard.crm.activities.index'),
                'is_admin'         => false,
            ],
        ]);
